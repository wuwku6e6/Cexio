...
## [Settings](https://github.com/wuwku6e6/Cexio/blob/main/.env-example)
...
## Installation
You can download the [**repository**](https://github.com/wuwku6e6/Cexio) by cloning it to your system and installing the necessary dependencies:
```shell
git clone https://github.com/wuwku6e6/Cexio.git
cd Cexio
```
